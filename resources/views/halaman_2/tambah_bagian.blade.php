          ...
          <div class="center">
            ...
            <div class="card shadow mb-4">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form action="{{ url('Simpan_Bagian') }}" method="post">
                 {{ csrf_field() }}
                  <div class="box-body">
                    <div class="form-group">
                      <label>Struktur Bagian Dkp3</label>
                      <input type="text" class="form-control" name="nama_bagian" placeholder="Bagian-Bagian">
                    </div>
